...
def ipd_dispatch(orders,buses,station_count,cfg):
    ...
    z={b.id:0.0 for b in buses}; u={b.id:0.0 for b in buses}; r={v:0.0 for v in range(station_count)}; q={v:0.0 for v in range(station_count)}; acc={}
    for o in orders:
        ...
        if dual>=o.priority or not feasible(o,b,sp,sx,sc,bt,st): continue
